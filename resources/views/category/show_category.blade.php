...
@section('content')
    ...
    <div id="livescroll">
        <div id="">
            <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 mt-10 lg:mt-20">
                <div class="text-center">
                    <h2 class="text-base font-semibold text-indigo-600 tracking-wide uppercase">{{ $category->name }}</h2>
